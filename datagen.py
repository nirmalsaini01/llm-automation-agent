...
def get_markdown(email: str) -> str:
...
def get_dates(email: str) -> list[str]:
...
def get_logs(email: str) -> list[tuple[int, str]]:
...
def get_docs(email: str) -> list[tuple[str, str, str]]:
...
def get_email(email: str) -> dict[str, str]:
    fake = Faker()
...
def get_credit_card(email: str) -> dict[str, str]:
    fake = Faker()
...
def get_comments(email: str) -> list[str]:
    fake = Faker()
...
def get_tickets(email: str) -> list[tuple[str, int, float]]:
